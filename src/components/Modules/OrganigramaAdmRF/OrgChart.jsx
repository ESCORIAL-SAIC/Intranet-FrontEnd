    ...
    if (props.data && d3Container.current) {
      ...
      chart
        ...
        .nodeContent(function (d, i, arr, state) {
            ...
            <div id="infoBox" style="display:flex;;color:#08011E;position:absolute;right:20px;top:8px;font-size:10px;align-items: center;">
              <p className="infoText-Date">${d.data.date}</p>
              <p className="infoText-Sal">${"$ " + new Intl.NumberFormat('de-DE').format(d.data.sal)}</p>
            </div>
